/**
 * find-browse — locate the opengstack browse binary.
 *
...
export function locateBinary(): string | null {
 ...
 const local = join(root, m, 'skills', 'OpenGStack', 'browse', 'dist', 'browse');
 ...
 // Global fallback
 for (const m of markers) {
 const global = join(home, m, 'skills', 'OpenGStack', 'browse', 'dist', 'browse');
