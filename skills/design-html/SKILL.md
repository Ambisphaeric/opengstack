...
description: |
 ...
 Proactively suggest when user has approved a design in /design-shotgun. (OpenGStack)
allowed-tools:
 - Bash
 - Read
 - Write
...
ls -t ~/.opengstack/projects/$SLUG/designs/*/approved.json 2>/dev/null | head -1
```
...
```bash
setopt +o nomatch 2>/dev/null || true
ls -t ~/.opengstack/projects/$SLUG/designs/*/finalized.html 2>/dev/null | head -1
```
...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.claude/skills/opengstack/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/.claude/skills/opengstack/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.claude/skills/opengstack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.claude/skills/opengstack/design-html/vendor/pretext.js
...
`~/.opengstack/projects/$SLUG/designs/<screen-name>-YYYYMMDD/finalized.html`

For framework output, save to:
`~/.opengstack/projects/$SLUG/designs/<screen-name>-YYYYMMDD/finalized.[tsx|svelte|vue]`
...
$B screenshot /tmp/opengstack-verify-mobile.png --width 375
$B screenshot /tmp/opengstack-verify-tablet.png --width 768
$B screenshot /tmp/opengstack-verify-desktop.png --width 1440
```
