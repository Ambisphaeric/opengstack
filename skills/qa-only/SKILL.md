...
description: |
 ...
 Proactively suggest when the user wants a bug report without any code changes. (OpenGStack)
allowed-tools:
 - Bash
 - Read
 - Write
...
| Mode | full | `--quick`, `--regression .OpenGStack/qa-reports/baseline.json` |
...
```bash
REPORT_DIR=".OpenGStack/qa-reports"
