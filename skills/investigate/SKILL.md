...
description: |
 ...
 yesterday", or is troubleshooting why something stopped working. (OpenGStack)
allowed-tools:
 - Bash
 - Read
 - Write
...
```bash
~/.claude/skills/opengstack/bin/opengstack-learnings-log '{"skill":"investigate","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
