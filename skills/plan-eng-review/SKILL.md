...
description: |
 ...
 start coding — to catch architecture issues before implementation. (OpenGStack)
...
```bash
~/.claude/skills/opengstack/bin/opengstack-review-log '{"skill":"plan-eng-review","timestamp":"TIMESTAMP","status":"STATUS","unresolved":N,"critical_gaps":N,"issues_found":N,"mode":"MODE","commit":"COMMIT"}'
```
