# Design System — opengstack

## Product Context
- **What this is:** Community website for opengstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering OpenGStack, existing community members
